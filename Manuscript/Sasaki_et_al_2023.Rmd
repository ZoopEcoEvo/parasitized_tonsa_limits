...
Five studies met our criteria for inclusion in the meta-analysis, yielding 15 contrasts between parasitized and unparasitized host animals. The studies included in the meta-analysis generally focused on amphibian parasitization by fungal or protistan parasites [@fernandez-loras2019; @greenspan2017; @sherman2008], but also included studies examining an arthropod host and bacterial parasite [@hector2019], and, as examined in our study, an arthropod host with an arthropod parasite [@agosta2018]. These studies generally reported a negative effect of parasitism on CT~max~, although in several cases confidence intervals overlapped zero (Figure 3). It is worth noting that each of the five previous studies included in this analysis examined the effect of parasites on their final host, while *Acartia tonsa* is the intermediate host for this isopod.

```{r, figure3, echo = F, out.width = "350px"}
#| fig.cap = "A forest plot showing the standardized mean difference estimate for each comparison of CTmax for infected and non-infected hosts, along with the 95 percent confidence interval. Each individual contrast from studies that included multiple host/pathogen species, life stages, etc. are indicated using decimals following the study ID. The size of each point is proportional to the weight of each contrast. The diamond at the bottom of the plot summarizes the overall effect estimate."
